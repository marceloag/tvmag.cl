...
async function main() {
  ...
  await sendCommand('Page.navigate', { url: 'http://localhost:3002' });
  
  console.log('Waiting 4 seconds for page to load and marquee animations to stabilize...');
  await sleep(4000);
  ...
  const desktopPath = '/Users/marceloag/.gemini/antigravity-cli/brain/dc7df57a-22d6-4bcc-a19b-61ec587cf2ef/screenshot_home_new.png';
  ...
  console.log('Waiting 2 seconds for mobile layout adaptation...');
  await sleep(2000);
  ...
  const mobilePath = '/Users/marceloag/.gemini/antigravity-cli/brain/dc7df57a-22d6-4bcc-a19b-61ec587cf2ef/screenshot_home_mobile_new.png';
